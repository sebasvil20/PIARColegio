...
$nombreItem = "hAutocItem";
$Item1 = "Es independiente en la realización de actividades básicas cotidianas";
$Item2 = "Sabe cómo prevenir accidentes en el lugar donde se encuentra (casa, colegio, calle)";
$Item3 = "Evita realizar acciones que pongan en riesgo su integridad física";
$Item4 = "Discrimina situaciones de enfermedad y sabe cómo cuidarse";
$Item5 = "Elige la opción que más le conviene entre dos opciones dadas";
$Item6 = "Identifica situaciones de abuso y sabe a quién acudir cuando se encuentra en peligro";
$Item7 = "Conoce su número de identificación, dirección, teléfono, así como la de sus responsables";
$Item8 = "Se desplaza en los lugares que le son familiares, sin necesidad de acompañamiento";
$Item9 = "Cumple con tareas asignadas de manera responsable";
$Item10 = "Hace uso adecuado de los materiales y entornos donde se encuentra";
$Item11 = "Discrimina el dinero y lo maneja adecuadamente";
$Item12 = "Sabe preparar alimentos sencillos sin supervisión de adultos";
$Item13 = "Reflexiona y se informa antes de tomar decisiones";
$Item14 = "Resuelve problemas cotidianos de manera socialmente aceptada";
...
<html lang="en">
<head>
    <title>Habilidades de autocuidado e independencia - Form</title>
    <meta charset="utf-8">
...
<section class="container text-center pt-3">
    ...
    <form action="../mainApp/sendData/SDHautoindepen.php" method="post">
    ...
    <section class="row text-center mt-5 border border-dark">
        ...
        <section class="row mt-3">
            ...
            <section class="col-8"><textarea class="form-control" name="textAreaObser" id="textArea" rows="3"></textarea></section>
        </section>
    </form>
    ...
    <section class="row mt-2 text-center">
        ...
        <section class="col-4"><label for="" id="hAutocNoObservado">0</label></section>
        <section class="col-4"><label for="" id=""></label></section>
    </section>
    <section class="row mt-2 text-center">
        <section class="col-4">Siempre (1)</section>
        <section class="col-4"><label for="" id="hAutocSiempre">0</label></section>
        <section class="col-4"><label for="" id=""></label></section>
    </section>
    <section class="row mt-2 text-center">
        <section class="col-4">A veces (2)</section>
        <section class="col-4"><label for="" id="hAutocAveces">0</label></section>
        <section class="col-4"><label for="" id=""></label></section>
    </section>
    <section class="row mt-2 text-center">
        <section class="col-4">Nunca (3)</section>
        <section class="col-4"><label for="" id="hAutocNunca">0</label></section>
        <section class="col-4"><label for="" id=""></label></section>
    </section>
</section>
<script>
    function limpiarDatos() {
        var i = 1;
        for(i=1;i<=14;i++){
            document.getElementById('hAutocItem'+i).selectedIndex='0';
    ...
    function calcular(){
        ...
        var noObservado = document.getElementById('hAutocNoObservado');
        var siempre = document.getElementById('hAutocSiempre');
        var aveces = document.getElementById('hAutocAveces');
        var nunca = document.getElementById('hAutocNunca');
        ...
        var items1 = [document.getElementById('hAutocItem1').selectedIndex, document.getElementById('hAutocItem2').selectedIndex,
            document.getElementById('hAutocItem3').selectedIndex, document.getElementById('hAutocItem4').selectedIndex,
            document.getElementById('hAutocItem5').selectedIndex, document.getElementById('hAutocItem6').selectedIndex,
            document.getElementById('hAutocItem7').selectedIndex, document.getElementById('hAutocItem8').selectedIndex,
            document.getElementById('hAutocItem9').selectedIndex, document.getElementById('hAutocItem10').selectedIndex,
            document.getElementById('hAutocItem11').selectedIndex, document.getElementById('hAutocItem12').selectedIndex,
            document.getElementById('hAutocItem13').selectedIndex, document.getElementById('hAutocItem14').selectedIndex];
